...
<html lang="en">
    <head>
        ...
        <title>Denim Jacket | Spiffy Sole</title>
    ...
    <body class="shop">
        <div id="page" class="hfeed page-wrapper">
                                                                ...
                                                                <div class="products-entry clearfix product-wapper">
                                                                    <div class="products-thumb">
                                                                        ...
                                                                        <div class="product-thumb-hover">
                                                                            <a href="https://api.whatsapp.com/send?phone=9205857379&text=Hi! I’d like to customize my jacket. What’s the process to do that?">
                                                                                <img width="600" height="600" src="media/product/Denim Jacket/set 1/1.jpg" class="post-image" alt="">
                                                                                <img width="600" height="600" src="media/product/Denim Jacket/set 1/2.jpg" class="hover-image back" alt="">
                                                                            </a>
                                                                        </div>
                                                                    </div>
                                                                    <div class="products-content">
                                                                        <div class="contents text-center">
                                                                            <h3 class="product-title">Design 1</h3>
                                                                            <span class="price"><a href="https://api.whatsapp.com/send?phone=9205857379&text=Hi! I’d like to customize my jacket. What’s the process to do that?">Buy Now</a></span>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            ...
                                                            <div class="col-xl-3 col-lg-4 col-md-4 col-sm-6">
                                                                <div class="products-entry clearfix product-wapper">
                                                                    <div class="products-thumb">
                                                                        ...
                                                                        <div class="product-thumb-hover">
                                                                            <a href="https://api.whatsapp.com/send?phone=9205857379&text=Hi! I’d like to customize my jacket. What’s the process to do that?">
                                                                                <img width="600" height="600" src="media/product/Denim Jacket/set 2/1.jpg" class="post-image" alt="">
                                                                                <img width="600" height="600" src="media/product/Denim Jacket/set 2/2.jpg" class="hover-image back" alt="">
                                                                            </a>
                                                                        </div>
                                                                    </div>
                                                                    <div class="products-content">
                                                                        <div class="contents text-center">
                                                                            <h3 class="product-title">Design 2</h3>
                                                                            <span class="price"><a href="https://api.whatsapp.com/send?phone=9205857379&text=Hi! I’d like to customize my jacket. What’s the process to do that?">Buy Now</a></span>
                                                                        </div>
                                                                    </div>
                                                                </div>
            ...
            <a href="https://api.whatsapp.com/send?phone=9205857379&text=Hi! I’d like to customize my jacket. What’s the process to do that?" class="float" target="_blank">
