<footer id="site-footer" class="site-footer" style="margin-top: 0px;">
    <div class="footer">
                    ...
                    <div class="row">
                        <div class="col-lg-3 col-md-6">
                            <div class="block block-image">
                                <img width="200" src="media/logo1.png" alt="">
                            </div>
                        </div>
                        <div class="col-lg-3 col-md-6">
                            <div class="block block-menu">
                                ...
                                <div class="block-content">
                                    <ul>
                                        <li>
                                            <a href="">+91 9205857379</a>
                                        </li>
                                        <li>
                                            <a href="">contact@spiffysole.com</a>
                                        </li>
                                    </ul>
                                </div>
                            </div>
                            ...
                            <div class="block block-social">
                                <ul class="social-link">
                                    ...
                                    <li><a href="https://www.instagram.com/spiffysole/?hl=en" target="_blank"><i class="fa fa-instagram"></i> Instagram </a></li>
                                </ul>
                            </div>
