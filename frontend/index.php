                                        ...
                                        <div class="item slick-slide">
                                            <div class="item-content">
                                                <div class="content-image">
                                                    <img width="1920" height="1080" src="media/Home Page Banner/Home Banner/Behind the Scenes 1920X720 PX.jpg" alt="Image Slider">
                                                </div>
<!--                                                <div class="section-padding">
                                        ...
                                        <div class="item slick-slide">
                                            <div class="item-content">
                                                <div class="content-image">
                                                    <img width="1920" height="1080" src="media/Home Page Banner/Home Banner/Jacket banner 1920X720 PX.jpg" alt="Image Slider">
                                                </div>
<!--                                                <div class="section-padding">
                                                    <div class="section-container">
                                                        <div class="item-info horizontal-start vertical-middle">
                                        ...
                                        <div class="item slick-slide">
                                            <div class="item-content">
                                                <div class="content-image">
                                                    <img width="1920" height="1080" src="media/Home Page Banner/Home Banner/Jeans Banner 1920X720 PX.jpg" alt="Image Slider">
                                                </div>
<!--                                                <div class="section-padding">
                                                    <div class="section-container">
                                                        <div class="item-info horizontal-start vertical-middle">
                                        ...
                                        <div class="item slick-slide">
                                            <div class="item-content">
                                                <div class="content-image">
                                                    <img width="1920" height="1080" src="media/Home Page Banner/Home Banner/Mario Banner 1920X720 PX.jpg" alt="Image Slider">
                                                </div>
<!--                                                <div class="section-padding">
                                                    <div class="section-container">
                                                        <div class="item-info horizontal-start vertical-middle">
                                        ...
                                        <div class="item slick-slide">
                                            <div class="item-content">
                                                <div class="content-image">
                                                    <img width="1920" height="1080" src="media/Home Page Banner/Home Banner/Rick and Morty banner 1920X720 PX.jpg" alt="Image Slider">
                                                </div>
<!--                                                <div class="section-padding">
                                                    <div class="section-container">
                                                        <div class="item-info horizontal-start vertical-middle">
                                        ...
                                        <div class="item slick-slide">
                                            <div class="item-content">
                                                <div class="content-image">
                                                    <img width="1920" height="1080" src="media/Home Page Banner/Home Banner/Tote Bag Banner 1920X720 PX.jpg" alt="Image Slider">
                                                </div>
<!--                                                <div class="section-padding">
                                                    <div class="section-container">
                                                        <div class="item-info horizontal-start vertical-middle">
                                                            ...
                                                            <div class="bg-banner">
                                                                <div class="banner-wrapper banners">
                                                                    <div class="banner-image">
                                                                        <a href="denim-jeans.php">
                                                                            <img width="571" height="622" src="media/banner/Banner 03.jpg" alt="Banner Image">
                                                                        </a>
                                                                    </div>
                                                                    <div class="banner-wrapper-infor">
                                                                        <div class="info">
                                                                            <div class="content">
                                                                                <a class="button button-white" href="denim-jeans.php">Jeans</a>
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                                            ...
                                                                            <div class="block-widget-banner layout-1">
                                                                                <div class="bg-banner">
                                                                                    <div class="banner-wrapper banners">
                                                                                        <div class="banner-image">
                                                                                            <a href="flats.php">
                                                                                                <img width="406" height="304" src="media/Home Page Banner/Product Banner/Tote Product Banner.jpg" alt="Banner Image">
                                                                                            </a>
                                                                                        </div>
                                                                                        <div class="banner-wrapper-infor">
                                                                                            <div class="info">
                                                                                                <div class="content">
                                                                                                    <a class="button button-white" href="flats.php">Tote Bag</a>
                                                                                                </div>
                                                                                            </div>
                                                                                        </div>
                                                                                    </div>
                                                                        ...
                                                                        <div class="block-widget-wrap">
                                                                            <div class="block-widget-banner layout-1">
                                                                                <div class="bg-banner">
                                                                                    <div class="banner-wrapper banners">
                                                                                        <div class="banner-image">
                                                                                            <a href="denim-jacket.php">
                                                                                                <img width="406" height="304" src="media/banner/Banner 04.jpg" alt="Banner Image">
                                                                                            </a>
                                                                                        </div>
                                                                                        <div class="banner-wrapper-infor">
                                                                                            <div class="info">
                                                                                                <div class="content">
                                                                                                    <a class="button button-white" href="denim-jacket.php">Denim Jackets</a>
                                                                                                </div>
                                                                                            </div>
                                                                                        </div>
                                                                                    </div>
                                                                            ...
                                                                            <div class="block-widget-banner layout-1">
                                                                                <div class="bg-banner">
                                                                                    <div class="banner-wrapper banners">
                                                                                        <div class="banner-image">
                                                                                            <a href="shoes.php">
                                                                                                <img width="406" height="304" src="media/Home Page Banner/Product Banner/Shoe product banner.jpg" alt="Banner Image">
                                                                                            </a>
                                                                                        </div>
                                                                                        <div class="banner-wrapper-infor">
                                                                                            <div class="info">
                                                                                                <div class="content">
                                                                                                    <a class="button button-white" href="shoes.php">Shoes</a>
                                                                                                </div>
                                                                                            </div>
                                                                                        </div>
                                                                                    </div>
                            ...
                            <section class="section section-padding m-b-70">
                                <div class="section-container large ">
                                    <div class="block-widget-wrap slider-for-section-3">
                                        <!-- Block Lookbook -->
                                                        ...
                                                        <div class="lookbook-wrap default"> 
                                                            <div class="lookbook-container">
                                                                <div class="lookbook-content">
                                                                    <div class="item">
                                                                        <img width="869" height="702" src="media/Home Page Banner/Bluk order Banner 2.jpg" alt="Look Book 1">
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="lookbook-intro-wrap position-center text-center">
                                                            <div class="lookbook-intro">
                                                                <h3 class="title"> Bulk Orders Open Now</h3>
                                                                <p class="sub-title text-dark">Looking for unique gifts or team outfits?<br>
                                                                                    This Christmas and New year, give the gift or style!<br>
                                                                                    Order in bulk for your company, events or loved ones,<br>
                                                                                    are create memorable personslized fashioin pieces they'll love.
                                                            </p>
                                                                <a href="custom-request-form.php" class="button button-white">Order Now</a>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="block block-lookbook no-space">
                                                ...
                                                <div class="row">
                                                    <div class="col-md-6">
                                                        <div class="lookbook-wrap default"> 
                                                            <div class="lookbook-container">
                                                                <div class="lookbook-content">
                                                                    <div class="item">
                                                                        <img width="869" height="702" src="<?=BASE_URL?>media/Home Page Banner/Wedding Banner.jpg" alt="Look Book 1">
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="lookbook-intro-wrap position-center text-center">
                                                            <div class="lookbook-intro">
                                                                <h3 class="title">Wedding Sneakers</h3>
                                                                <p class="sub-title text-dark"><strong>Your Day, Your Design</strong><br>
                                                                                    Custom Wedding Sneakers to Match Your Style.
                                                            </p>
                                                                <a href="custom-request-form.php" class="button button-white">Order Now</a>
                                                            </div>
                                                        </div>
