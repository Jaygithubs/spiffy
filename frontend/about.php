...
<html lang="en">
    <head>
        ...
        <title>About Us | Spiffy Sole</title>
                                                                ...
                                                                <div class="col-md-6">
                                                                    <div class="banner-image">
                                                                        <a href="shop-grid-left.html">
                                                                            <img src="media/banner/about-us-2.jpg" alt="Banner Image">
                                                                        </a>
                                                                    </div>
                                                                </div>
                                                                    ...
                                                                    <div class="banner-wrapper-infor">
                                                                        <div class="info">
                                                                            <div class="content">
                                                                                ...
                                                                                <a class="link-title">
                                                                                    <h3 class="title-banner">About Us</h3>
                                                                                </a>
                                                                                <div class="banner-image-description">
                                                                                    Welcome to Spiffy Sole—a hub where fashion meets personal expression. We are passionate about redefining streetwear, enabling you to customize and elevate your style to match your unique identity. Explore our innovative designs and create a look that's exclusively yours, embracing the urban canvas like never before. Step into a world of individuality with Spiffy Sole.
                                                                                </div><br/><br/>
                                                                                <div class="banner-image-description">
                                                                                    Hey I'm Diksha—an impassioned artist and the creative visionary driving this brand. With a heart devoted to artistry and an eye for fashion, I founded this venture to blend the two seamlessly. Spiffy Sole is more than a brand; it's a culmination of my passion and your unique style, coming together to redefine the world of custom streetwear. Join me on this artistic journey as we craft personalized expressions that tell your story through every stroke of brush.
                                                                                </div>
                                                        ...
                                                        <div class="banners">
                                                            <div class="row">
                                                                        ...
                                                                        <div class="info">
                                                                            <div class="content">
                                                                                ...
                                                                                <a class="link-title" href="blog-grid-right.html">
                                                                                    <h3 class="title-banner">Cost Details</h3>
                                                                                </a>
                                                                                <div class="banner-image-description">
                                                                ...
                                                                <div class="col-md-6">
                                                                    <div class="banner-image">
                                                                        <a href="shop-grid-left.html">
                                                                            <img src="media/banner/about-us-3.jpg" alt="Banner Image">
                                                                        </a>
                                                                    </div>
                                                                </div>
                                                            </div>
