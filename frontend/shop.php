                                                        ...
                                                        <div class="row">
                                                                ...
                                                                <div class="products-entry clearfix product-wapper">
                                                                    ...
                                                                    <div class="products-content">
                                                                        <div class="contents text-center">
                                                                            <h3 class="product-title"><a href="shop-details.php">Dining Table</a></h3>
                                                            ...
                                                            <div class="col-xl-3 col-lg-4 col-md-4 col-sm-6">
                                                                <div class="products-entry clearfix product-wapper">
                                                                    ...
                                                                    <div class="products-content">
                                                                        <div class="contents text-center">
                                                                            <h3 class="product-title"><a href="shop-details.php">Pillar Dining Table Round</a></h3>
                                                                            <span class="price">
                                                            ...
                                                            <div class="col-xl-3 col-lg-4 col-md-4 col-sm-6">
                                                                <div class="products-entry clearfix product-wapper">
                                                                    ...
                                                                    <div class="products-content">
                                                                        <div class="contents text-center">
                                                                            <h3 class="product-title"><a href="shop-details.php">Mags Sofa 2.5 Seater</a></h3>
                                                                            <span class="price">$150.00</span>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                            ...
                                                            <div class="col-xl-3 col-lg-4 col-md-4 col-sm-6">
                                                                <div class="products-entry clearfix product-wapper">
                                                                    ...
                                                                    <div class="products-content">
                                                                        <div class="contents text-center">
                                                                            <h3 class="product-title"><a href="shop-details.php">Spinning pendant lamp</a></h3>
                                                                            <span class="price">
                                                                                <del aria-hidden="true"><span>$150.00</span></del> 
                                                                                <ins><span>$100.00</span></ins>
                                                                            </span>
                                                            ...
                                                            <div class="col-xl-3 col-lg-4 col-md-4 col-sm-6">
                                                                <div class="products-entry clearfix product-wapper">
                                                                    ...
                                                                    <div class="products-content">
                                                                        <div class="contents text-center">
                                                                            <h3 class="product-title"><a href="shop-details.php">Bora Armchair</a></h3>
                                                                            <span class="price">
                                                            ...
                                                            <div class="col-xl-3 col-lg-4 col-md-4 col-sm-6">
                                                                <div class="products-entry clearfix product-wapper">
                                                                    ...
                                                                    <div class="products-content">
                                                                        <div class="contents text-center">
                                                                            <h3 class="product-title"><a href="shop-details.php">Panton Dining Table</a></h3>
                                                                            <span class="price">
                                                            ...
                                                            <div class="col-xl-3 col-lg-4 col-md-4 col-sm-6">
                                                                <div class="products-entry clearfix product-wapper">
                                                                    ...
                                                                    <div class="products-content">
                                                                        <div class="contents text-center">
                                                                            <h3 class="product-title"><a href="shop-details.php">Kittchen Table</a></h3>
                                                            ...
                                                            <div class="col-xl-3 col-lg-4 col-md-4 col-sm-6">
                                                                <div class="products-entry clearfix product-wapper">
                                                                    ...
                                                                    <div class="products-content">
                                                                        <div class="contents text-center">
                                                                            <h3 class="product-title"><a href="shop-details.php">Mundo Sofa With Cushion</a></h3>
                                                                            <span class="price">
                                                            ...
                                                            <div class="col-xl-3 col-lg-4 col-md-4 col-sm-6">
                                                                <div class="products-entry clearfix product-wapper">
                                                                    ...
                                                                    <div class="products-content">
                                                                        <div class="contents text-center">
                                                                            <h3 class="product-title"><a href="shop-details.php">Amp Pendant Light Large</a></h3>
                        ...
                        <table class="wishlist-items">                        
                            <tbody>
                                <tr class="wishlist-item">
                                    ...
                                    <td class="wishlist-item-info">
                                        <div class="wishlist-item-name">
                                            <a href="shop-details.php">Chair Oak Matt Lacquered</a>
                                        </div>
                                ...
                                <tr class="wishlist-item">
                                    ...
                                    <td class="wishlist-item-info">
                                        <div class="wishlist-item-name">
                                            <a href="shop-details.php">Pillar Dining Table Round</a>
                                        </div>
                                        <div class="wishlist-item-price">
                                            <del aria-hidden="true"><span>$150.00</span></del> 
                                            <ins><span>$100.00</span></ins>
