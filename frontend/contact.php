                                        ...
                                        <div class="block block-contact-form">
                                            <div class="block-widget-wrap">
                                                <div class="block-title">
                                                    ...
                                                    <div class="sub-title">Give a detailed description of your dream design.<br/>
                                                    After receiving your request, we will reach out for a one-on-one consultation to discuss design, concept and budget. There will be a required deposit based on the cost of the work.
                                                    </div>
                                                </div>
                                                <div class="block-content">
                                                    <form action="" method="post" class="contact-form" novalidate="novalidate">
                                                        <div class="contact-us-form">
                                                            ...
                                                            <div class="row">
                                                                <div class="col-sm-12">
                                                                    <label class="required">Message (Design Requirements)</label><br>
                                                                    <span class="form-control-wrap">
